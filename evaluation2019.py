...
def calculate_tDCF_EER(cm_scores_file,
    ...
    # Load CM scores
    dtype = [('TRIAL_NAME', 'U20'), ('CM_SCORE', 'f8'), ('utt_id', 'U10'), ('_', 'U1'), ('source', 'U3'), ('key', 'U10')]

    # Load the data into a structured NumPy array
    cm_data = np.genfromtxt(cm_scores_file, delimiter=',', dtype=dtype, skip_header=1)
    # cm_utt_id = cm_data[:, 0]
    cm_sources = cm_data["source"]
    cm_keys = cm_data["key"]
    cm_scores = cm_data["CM_SCORE"]
